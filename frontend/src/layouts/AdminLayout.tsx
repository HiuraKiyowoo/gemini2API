...
const navItems = [
  ...
  { name: "Log Aktivitas", path: "/logs", icon: ScrollText },
      ...
      >
        <div className="flex h-20 items-center justify-between border-b border-border/45 px-6">
          <Link to="/" onClick={() => setMobileOpen(false)} className="group min-w-0">
            ...
            <div className="mt-1 truncate text-2xl font-black tracking-tight transition group-hover:text-primary">gemini2API</div>
          </Link>
          <button
            type="button"
