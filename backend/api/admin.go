...
func AdminRoutes() []RouteSpec {
	return []RouteSpec{
		...
		{Method: "GET", Path: "/admin/accounts", Auth: "admin", Description: "list gemini accounts"},
		{Method: "POST", Path: "/admin/accounts", Auth: "admin", Description: "import or create gemini account"},
		{Method: "DELETE", Path: "/admin/accounts", Auth: "admin", Description: "delete gemini account"},
