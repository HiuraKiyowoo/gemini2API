...
<div align="center">
  <a href="https://github.com/YuJunZhiXue/gemini2API">
    <img src="https://img.shields.io/badge/Gemini-2API-1677ff?style=for-the-badge&logo=alibabacloud&logoColor=white" alt="gemini2API" height="80">
  </a>
  ...
  <p>
    <a href="https://github.com/YuJunZhiXue/gemini2API">GitHub</a> ·
    <a href="https://hub.docker.com/r/yujunzhixue/gemini2api">Docker Hub</a> ·
    <a href="https://t.me/gemini2api">Telegram</a> ·
    <a href="./README.md">English README</a>
  </p>

  <p>
    <a href="https://github.com/YuJunZhiXue/gemini2API/releases">
      <img src="https://img.shields.io/github/v/release/YuJunZhiXue/gemini2API?logo=github&label=Version&style=flat-square" alt="Release">
    </a>
    <a href="https://github.com/YuJunZhiXue/gemini2API/stargazers">
      <img src="https://img.shields.io/github/stars/YuJunZhiXue/gemini2API?logo=github&style=flat-square&label=Stars" alt="Stars">
    </a>
    <a href="https://hub.docker.com/r/yujunzhixue/gemini2api">
      <img src="https://img.shields.io/badge/Docker%20Hub-yujunzhixue%2Fgemini2api-2496ED?logo=docker&style=flat-square" alt="Docker Hub">
    </a>
...
gemini2API 将千问 Web 能力转换为常见 API 协议，并提供本地 WebUI，用于管理上游账号、下游 API Key、运行配置、模型测试、图片测试和视频测试。
...
services:
  gemini2api:
    image: ${QWEN2API_IMAGE:-yujunzhixue/gemini2api:latest}
...
docker compose pull
docker compose up -d
docker compose logs -f gemini2api
```
...
```bash
git clone https://github.com/YuJunZhiXue/gemini2API.git
cd gemini2API
cp .env.example .env
...
cd backend
go test ./...
go build -trimpath -ldflags="-s -w" -o ..\bin\gemini2api-backend.exe .
```
...
- 🐛 [报告 Bug](https://github.com/YuJunZhiXue/gemini2API/issues)
- 💡 [功能建议](https://github.com/YuJunZhiXue/gemini2API/issues)
- 🔧 [提交代码](https://github.com/YuJunZhiXue/gemini2API/pulls)
- 💬 [Telegram 交流](https://t.me/gemini2api)

### 2. 贡献列表

感谢所有帮助改进 gemini2API 的贡献者。

[![Contributors](https://contrib.rocks/image?repo=YuJunZhiXue/gemini2API)](https://github.com/YuJunZhiXue/gemini2API/graphs/contributors)

## 六、其他信息

### 1. Star History

[![Star History Chart](https://api.star-history.com/svg?repos=YuJunZhiXue/gemini2API&type=Timeline)](https://www.star-history.com/#YuJunZhiXue/gemini2API&Timeline)
...
<div align="center">
  <p>如果 gemini2API 对你有帮助，可以考虑给项目一个 Star。</p>
